...
namespace ProgressTable.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            {
                new Student{Name="Мельников Илья Сергеевич", Visual=0, Architecture=0, Networks=0 },
                new Student{Name="Махонин Павел Николаевич", Visual=2, Architecture=2, Networks=2 },
                new Student{Name="Лазарев Семен Денисович", Visual=1, Architecture=1, Networks=1 },
            };
            CheckAverage(students);
